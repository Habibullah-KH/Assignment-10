...
<div className="rounded-2xl bg-black shadow-xl col-span-2 md:col-span-1">
  <div>
    <img
    className="rounded-2xl max-h-72"
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
      <button className="btn text-white hover:text-black">GET FINANCING</button>
    </div>
  </div>
</div>
...
<div className="rounded-2xl bg-black shadow-xl col-span-2 md:col-span-1">
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
      <button className="btn text-white hover:text-black">Best Desktop deals</button>
    </div>
  </div>
</div>
            </div>
